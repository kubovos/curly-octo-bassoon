...
import "0xf09ef1bd520b70c08d7e048c6a9004bdac1ba504-Presale/@openzeppelin/contracts/access/Ownable.sol";
import "0xf09ef1bd520b70c08d7e048c6a9004bdac1ba504-Presale/@openzeppelin/contracts/utils/math/SafeMath.sol";
import "0xf09ef1bd520b70c08d7e048c6a9004bdac1ba504-Presale/@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "0xf09ef1bd520b70c08d7e048c6a9004bdac1ba504-Presale/@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import "0xf09ef1bd520b70c08d7e048c6a9004bdac1ba504-Presale/@chainlink/contracts/src/v0.8/interfaces/AggregatorV2V3Interface.sol";
...
contract Presale is IPreIDOBase, Ownable {
    ...
    constructor(
        address _token,
        address _priceFeed // uint256 _notBeforeBlock, // uint256 _notAfterBlock
    ) {
        require(
    ...
    function _order(
        ...
        uint256 tokenPriceX4 = (tokenPrice * 10000 * (100 - discountsRate)) /
            100;
        ...
        if (upperPow >= lowerPow) {
            distributeAmount = distributeAmount.mul(
                10 ** (upperPow - lowerPow)
            );
        } else {
            distributeAmount = distributeAmount.div(
                10 ** (lowerPow - upperPow)
            );
        }
        require(
